...
func parseAuthzGrantArgs(authzGrantMsg types.AuthzGrantMsg, privKey key.PrivateKey) (authz.MsgGrant, error) {
	...
	if authzGrantMsg.Granter != granter.String() {
		return authz.MsgGrant{}, util.LogErr("Account address generated by private key is not equal input granter of msg")
	}
	...
	case "send":
		...
		if limit == "" {
			return authz.MsgGrant{}, util.LogErr("require bank spend limit")
		}
		...
		if !spendLimit.IsAllPositive() {
			return authz.MsgGrant{}, util.LogErr("spend-limit should be greater than zero")
		}
	...
	case "delegate", "unbond", "redelegate":
		limit := authzGrantMsg.SpendLimit
		if limit == "" {
			return authz.MsgGrant{}, util.LogErr("require spend limit")
		}
	...
	default:
		return authz.MsgGrant{}, util.LogErr("invalid authorization type, ", authzGrantMsg.AuthorizationType)
	}
